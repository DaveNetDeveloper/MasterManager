...
<div class="row">
	<div class="column width-12">
		<div class="row content-grid-1">  
            <asp:GridView  ID="GvEntityList" runat="server">
                <%-- OnRowDataBound="GvEntityList_RowDataBound" Width="100%" 
                Visible="true" OnRowCommand="GvEntityList_RowCommand" DataKeyNames="Id" AutoGenerateColumns="false" CssClass ="gridClass"EmptyDataText="No hay datos." 
     ...
     <div>
        <asp:Button OnClick="ExportExcel" Visible="true" runat="server" ID="btnExportExcel" style="border-radius:0px" Text="Exportar a Excel" CssClass="blue" Width="150px" /> 
    </div>
</div>  
